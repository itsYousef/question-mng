...
class PdfAScreen extends React.Component {
  ...
  render() {
    const source = { uri: this.props.navigation.state.params.uriA, cache: !this.state.error };
      ...
      <View style={styles.container}>
        ...
        {this.state.loading
          ...
          <View style={{ alignItems: 'center', justifyContent: 'center', paddingTop: 24 }}>
            <Text style={{ fontFamily: 'Vazir-Medium', fontSize: 18, color: 'white', textAlign: 'center' }}>در حال دریافت فایل پاسخ ها</Text>
          </View>
          :
          null
        }
